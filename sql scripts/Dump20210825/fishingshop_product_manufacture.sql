...
CREATE TABLE `product_manufacture` (
  ...
  `manufacture` varchar(60) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `manufacture_UNIQUE` (`manufacture`)
...
INSERT INTO `product_manufacture` VALUES (4,'kaida'),(5,'other'),(3,'owner'),(1,'salmo'),(2,'shimano');
...
-- Dump completed on 2021-08-25 19:47:29
